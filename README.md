...
| 项目 | 月成本（人民币） | 年成本 | 10年成本 |
|------|----------------|--------|----------|
| 5人工资（5000/人） | 25,000 | 300,000 | 3,000,000 |
| 场地租金 | 5,000 | 60,000 | 600,000 |
| 水电、网络 | 2,000 | 24,000 | 240,000 |
| 服务器、工具、备份 | 1,000 | 12,000 | 120,000 |
| **小计** | **33,000** | **396,000** | **3,960,000 ≈ 55万美元** |

剩余45万美元用于：应急储备、审计、法律、推广、差旅。

---

### 投资者权益

- **出资100万美元，占20%股份**（创始团队80%，含15%期权池）
- 股份形式：BVI公司股权（未来可映射代币）
- 一票否决权仅限"改变核心仲裁规则"或"出售公司"

### 退出路径（3-5年）

下一轮融资（A轮或生态轮）时**卖出部分或全部股份**：

- 估值5000万 → 你的20%值1000万（**10倍**）
- 估值1亿 → 你的20%值2000万（**20倍**）
- 或被战略收购，按比例分钱
- 或项目转为DAO，你持有治理代币，享受仲裁费分红
...
- 100万美元存入**3/5多签钱包**
  - 签名方：创始人、投资者、技术合伙人、律师、社区代表
- 每月固定支出（工资/房租/服务器）列入**自动执行列表**，无需逐笔审批
- 投资者**不能单方面撤回资金**。想退出只能转让股份
- 如果投资者失联或恶意冻结，剩余签名方可投票降低其权限（写入初始合同）

---

### 风险披露（必须看）

- ⚠️ 项目完全失败概率**95%以上**（市场没起来 / 技术被超越 / 团队解散）
- ⚠️ 你的100万美元可能**血本无归**
- ⚠️ 没有保本，没有固定回报，这是**一场理智的豪赌**

**一句话总结：投100万，占20%，3-5年后下一轮退出，目标10-20倍。输了认赔。**
...
- **创始人**：初中没毕业，做过百台游戏工作室，看透AI交易风口
- **现状**：已关闭原游戏工作室，**10台机器跑代码**
- **进展**：核心代码已完成，第一笔真实交易已跑通
...
#### 3. 运营经理（Discord/Twitter/内容）

**职责**：
- 运营社交媒体（Twitter/LinkedIn）
- 制作技术博客和视频
- 组织线上AMA和社区活动
...
发送邮件至：**86609013@qq.com**

邮件标题格式：`[应聘角色] 姓名 - 为什么我是那个疯子`
